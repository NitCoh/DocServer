...
public interface Server<T> extends Closeable {
     ...
     */
//    public static <T> Server.Server<T>  threadPerClient(
//            int port,
...
//            @Override
//            protected void execute(Server.BlockingConnectionHandler<T>  handler) {
...
//    }
     ...
     */
//    public static <T> Server.Server<T> reactor(
//            int nthreads,
//            int port,
//            Supplier<DocProtocol<T>> protocolFactory,
//            Supplier<MessageEncoderDecoder<T>> encoderDecoderFactory) {
//        return new DocTPC<T>(nthreads, port, protocolFactory, encoderDecoderFactory);
//    }
